...
class ObjectSchemaInitializationTests: TestCase {
    ...
    func testCustomPropertyPopulation() {
        ...
        // assertType(EmbeddedObjectWrapper?.self, .object, optional: true, objectType: "RealmSwiftEmbeddedObject")
...
//        assertType(List<EmbeddedObjectWrapper>.self, .object, list: true, objectType: "RealmSwiftEmbeddedObject")
        ...
        // assertType(MutableSet<EmbeddedObjectWrapper>.self, .object, set: true, objectType: "RealmSwiftEmbeddedObject")
        ...
        // assertType(Map<String, EmbeddedObjectWrapper?>.self, .object, optional: true, map: true, objectType: "RealmSwiftEmbeddedObject")
    }
