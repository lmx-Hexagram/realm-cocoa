...
class QueryTests: TestCase {
    ...
    private func assertCollectionQuery<Root: LinkToTestObject>(
            _ type: Root.Type, _ predicate: String, _ value: Any,
            query: ((Query<Root.Child>) -> Query<Bool>)) {
        assertPredicate(predicate, [value], query)
        let obj = realm.objects(Root.self).first!
        XCTAssertEqual(obj.list.where(query).count, 1)
        XCTAssertEqual(obj.set.where(query).count, 1)
        // XCTAssertEqual(obj.map.where(query).count, 1)
    }
    ...
    func testMemberwiseEquality() {
        ...
        let linkObj3 = realm.create(LinkToAddressSwiftWrapper.self, value: [obj3, obj3])
    ...
    private func validateStringOperations<Root: Object, T: _Persistable>(
            _ name: String, _ lhs: (Query<Root>) -> Query<T>,
            _ values: (T, T, T), matchingCount: Int, notMatchingCount: Int)
    ...
    func testCollectionFromProperty() {
        ...
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(boolCol == %@)", false) {
            $0.boolCol == false
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(intCol == %@)", 3) {
            $0.intCol == 3
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(int8Col == %@)", Int8(9)) {
            $0.int8Col == Int8(9)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(int16Col == %@)", Int16(17)) {
            $0.int16Col == Int16(17)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(int32Col == %@)", Int32(33)) {
            $0.int32Col == Int32(33)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(int64Col == %@)", Int64(65)) {
            $0.int64Col == Int64(65)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(floatCol == %@)", Float(6.55444333)) {
            $0.floatCol == Float(6.55444333)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(doubleCol == %@)", 234.567) {
            $0.doubleCol == 234.567
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(stringCol == %@)", "Foó") {
            $0.stringCol == "Foó"
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(binaryCol == %@)", Data(count: 128)) {
            $0.binaryCol == Data(count: 128)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(dateCol == %@)", Date(timeIntervalSince1970: 2000000)) {
            $0.dateCol == Date(timeIntervalSince1970: 2000000)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(decimalCol == %@)", Decimal128(234.567)) {
            $0.decimalCol == Decimal128(234.567)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(objectIdCol == %@)", ObjectId("61184062c1d8f096a3695045")) {
            $0.objectIdCol == ObjectId("61184062c1d8f096a3695045")
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(uuidCol == %@)", UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09f")!) {
            $0.uuidCol == UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09f")!
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(intEnumCol == %@)", ModernIntEnum.value2) {
            $0.intEnumCol == .value2
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(stringEnumCol == %@)", ModernStringEnum.value2) {
            $0.stringEnumCol == .value2
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(bool == %@)", BoolWrapper(persistedValue: false)) {
            $0.bool == BoolWrapper(persistedValue: false)
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(int == %@)", IntWrapper(persistedValue: 3)) {
            $0.int == IntWrapper(persistedValue: 3)
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(int8 == %@)", Int8Wrapper(persistedValue: Int8(9))) {
            $0.int8 == Int8Wrapper(persistedValue: Int8(9))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(int16 == %@)", Int16Wrapper(persistedValue: Int16(17))) {
            $0.int16 == Int16Wrapper(persistedValue: Int16(17))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(int32 == %@)", Int32Wrapper(persistedValue: Int32(33))) {
            $0.int32 == Int32Wrapper(persistedValue: Int32(33))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(int64 == %@)", Int64Wrapper(persistedValue: Int64(65))) {
            $0.int64 == Int64Wrapper(persistedValue: Int64(65))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(float == %@)", FloatWrapper(persistedValue: Float(6.55444333))) {
            $0.float == FloatWrapper(persistedValue: Float(6.55444333))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(double == %@)", DoubleWrapper(persistedValue: 234.567)) {
            $0.double == DoubleWrapper(persistedValue: 234.567)
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(string == %@)", StringWrapper(persistedValue: "Foó")) {
            $0.string == StringWrapper(persistedValue: "Foó")
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(binary == %@)", DataWrapper(persistedValue: Data(count: 128))) {
            $0.binary == DataWrapper(persistedValue: Data(count: 128))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(date == %@)", DateWrapper(persistedValue: Date(timeIntervalSince1970: 2000000))) {
            $0.date == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2000000))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(decimal == %@)", Decimal128Wrapper(persistedValue: Decimal128(234.567))) {
            $0.decimal == Decimal128Wrapper(persistedValue: Decimal128(234.567))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(objectId == %@)", ObjectIdWrapper(persistedValue: ObjectId("61184062c1d8f096a3695045"))) {
            $0.objectId == ObjectIdWrapper(persistedValue: ObjectId("61184062c1d8f096a3695045"))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(uuid == %@)", UUIDWrapper(persistedValue: UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09f")!)) {
            $0.uuid == UUIDWrapper(persistedValue: UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09f")!)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optBoolCol == %@)", false) {
            $0.optBoolCol == false
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optIntCol == %@)", 3) {
            $0.optIntCol == 3
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optInt8Col == %@)", Int8(9)) {
            $0.optInt8Col == Int8(9)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optInt16Col == %@)", Int16(17)) {
            $0.optInt16Col == Int16(17)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optInt32Col == %@)", Int32(33)) {
            $0.optInt32Col == Int32(33)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optInt64Col == %@)", Int64(65)) {
            $0.optInt64Col == Int64(65)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optFloatCol == %@)", Float(6.55444333)) {
            $0.optFloatCol == Float(6.55444333)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optDoubleCol == %@)", 234.567) {
            $0.optDoubleCol == 234.567
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optStringCol == %@)", "Foó") {
            $0.optStringCol == "Foó"
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optBinaryCol == %@)", Data(count: 128)) {
            $0.optBinaryCol == Data(count: 128)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optDateCol == %@)", Date(timeIntervalSince1970: 2000000)) {
            $0.optDateCol == Date(timeIntervalSince1970: 2000000)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optDecimalCol == %@)", Decimal128(234.567)) {
            $0.optDecimalCol == Decimal128(234.567)
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optObjectIdCol == %@)", ObjectId("61184062c1d8f096a3695045")) {
            $0.optObjectIdCol == ObjectId("61184062c1d8f096a3695045")
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optUuidCol == %@)", UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09f")!) {
            $0.optUuidCol == UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09f")!
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optIntEnumCol == %@)", ModernIntEnum.value2) {
            $0.optIntEnumCol == .value2
        }
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optStringEnumCol == %@)", ModernStringEnum.value2) {
            $0.optStringEnumCol == .value2
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optBool == %@)", BoolWrapper(persistedValue: false)) {
            $0.optBool == BoolWrapper(persistedValue: false)
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optInt == %@)", IntWrapper(persistedValue: 3)) {
            $0.optInt == IntWrapper(persistedValue: 3)
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optInt8 == %@)", Int8Wrapper(persistedValue: Int8(9))) {
            $0.optInt8 == Int8Wrapper(persistedValue: Int8(9))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optInt16 == %@)", Int16Wrapper(persistedValue: Int16(17))) {
            $0.optInt16 == Int16Wrapper(persistedValue: Int16(17))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optInt32 == %@)", Int32Wrapper(persistedValue: Int32(33))) {
            $0.optInt32 == Int32Wrapper(persistedValue: Int32(33))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optInt64 == %@)", Int64Wrapper(persistedValue: Int64(65))) {
            $0.optInt64 == Int64Wrapper(persistedValue: Int64(65))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optFloat == %@)", FloatWrapper(persistedValue: Float(6.55444333))) {
            $0.optFloat == FloatWrapper(persistedValue: Float(6.55444333))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optDouble == %@)", DoubleWrapper(persistedValue: 234.567)) {
            $0.optDouble == DoubleWrapper(persistedValue: 234.567)
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optString == %@)", StringWrapper(persistedValue: "Foó")) {
            $0.optString == StringWrapper(persistedValue: "Foó")
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optBinary == %@)", DataWrapper(persistedValue: Data(count: 128))) {
            $0.optBinary == DataWrapper(persistedValue: Data(count: 128))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optDate == %@)", DateWrapper(persistedValue: Date(timeIntervalSince1970: 2000000))) {
            $0.optDate == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2000000))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optDecimal == %@)", Decimal128Wrapper(persistedValue: Decimal128(234.567))) {
            $0.optDecimal == Decimal128Wrapper(persistedValue: Decimal128(234.567))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optObjectId == %@)", ObjectIdWrapper(persistedValue: ObjectId("61184062c1d8f096a3695045"))) {
            $0.optObjectId == ObjectIdWrapper(persistedValue: ObjectId("61184062c1d8f096a3695045"))
        }
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optUuid == %@)", UUIDWrapper(persistedValue: UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09f")!)) {
    ...
    func testMapAllValues() {
        ...
        validateStringOperations("ANY mapString.@allValues", \Query<ModernAllTypesObject>.mapString.values,
                                 ("Foo", "Foo", "Foo"), matchingCount: 1, notMatchingCount: 1)
        ...
        validateStringOperations("ANY mapString.@allValues", \Query<ModernCollectionsOfEnums>.mapString.values,
                                 (.value1, .value1, .value1), matchingCount: 1, notMatchingCount: 1)
        ...
        validateStringOperations("ANY mapString.@allValues", \Query<CustomPersistableCollections>.mapString.values,
                                 (StringWrapper(persistedValue: "Foo"), StringWrapper(persistedValue: "Foo"), StringWrapper(persistedValue: "Foo")), matchingCount: 1, notMatchingCount: 1)
